...
<!-- Delete Permission Player Modal -->
<div wire:ignore.self class="modal fade" id="deletePermissionPlayerModal" tabindex="-1" aria-labelledby="deletePermissionPlayerModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deletePermissionPlayerModalLabel">Delete Permission Player Confirm</h5>
                <button type="button" class="btn-close" data-mdb-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete all permission data for player {{ $name }} ({{ $playerUuid }})?</p>
            </div>
            <div class="modal-footer">
