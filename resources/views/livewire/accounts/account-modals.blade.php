<!-- Show Account Modal -->
<x-modal id="showAccountModal" title="Show Account">
    <div class="mb-3">
...
<!-- Add Account Modal -->
<x-modal id="addAccountModal" title="{{ __('accounts.accounts.modal.add.title') }}" :hasForm="true" wire:submit.prevent="createAccount">
    <div class="mb-3">
    ...
    <x-slot name="footer">
        <button type="button" class="btn btn-secondary" wire:click="closeModal"
                data-mdb-dismiss="modal">@lang('accounts.accounts.modal.close')</button>
        <button type="submit" class="btn btn-primary">@lang('accounts.accounts.modal.add.submit-button')</button>
    </x-slot>
</x-modal>

<!-- Edit Account Modal -->
<x-modal id="editAccountModal" title="{{ __('accounts.accounts.modal.edit.title') }}" :hasForm="true" wire:submit.prevent="updateAccount">
    <div class="mb-3">
...
<x-modal id="deleteAccountModal" title="{{ __('accounts.accounts.modal.delete.title') }}">
